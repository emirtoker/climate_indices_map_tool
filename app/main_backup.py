...
# 2. CSS: SAĞ ÜST 2-SÜTUN GRID + TAŞMA KORUMASI
st.markdown("""
    <style>
    /* Lejant Konteynırı: Sağ Üst 2 Sütunlu Grid */
    ...
    /* Katman Kontrolü (Layer Control) Fix */
    ...
    .leaflet-vigl-grid-line { display: none !important; opacity: 0 !important; }
...
# 4. Veri Yükleme (State Kontrollü Hafıza)
all_requested = set()
